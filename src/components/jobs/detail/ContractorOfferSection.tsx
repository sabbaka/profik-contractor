  ...
  if (!hasOffered && (jobStatus === "completed" || jobStatus === "canceled")) {
    ...
    return (
      ...
      >
        <Text variant="h5">
          {canceled
            ? t("offer.closed.canceledTitle")
            : t("offer.closed.completedTitle")}
        </Text>
        <Text variant="caption">
          {canceled
            ? t("offer.closed.canceledBody")
            : t("offer.closed.completedBody")}
        </Text>
      </YStack>
    );
  }
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Text variant="priceLg" style={{ color: colors.accent }}>
            {formatCzk(myOfferPrice ?? 0)}
          </Text>
          {myOfferMessage ? (
            <Text
              variant="bodySm"
              style={{ color: colors.textPrimary, marginTop: 5 }}
            >
              {myOfferMessage}
            </Text>
          ) : null}
  ...
  if (mode === "counter") {
    ...
    return (
      ...
      >
        ...
        {canAffordOffer ? (
          <>
            ...
            <Button
              ...
              disabled={!valid}
              iconLeft={<Send size={17} color="#FFFFFF" />}
        ...
        <Button variant="ghost" size="sm" onPress={() => setMode("idle")}>
          {t("common.cancel")}
        </Button>
      </YStack>
    );
    ...
    >
      <XStack alignItems="center" gap={12}>
        ...
        <YStack flex={1} gap={2}>
          ...
          <Text variant="caption">
            {canAffordOffer
              ? t("offer.interestedBody")
              : t("offer.balance.interestedBody")}
          </Text>
        </YStack>
      </XStack>
      {canAffordOffer ? (
