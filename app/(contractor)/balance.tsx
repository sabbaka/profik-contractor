  ...
  if (isBalanceLoading) {
    return (
      ...
      >
        ...
        <Text variant="bodySm">{t("balance.loading")}</Text>
      </YStack>
    );
  }
  ...
  if (balance === undefined) {
    return (
      <YStack
        ...
        gap={12}
      >
        <Text variant="h4">{t("balance.loadFailed")}</Text>
        <Button
          variant="secondary"
          size="md"
          fullWidth={false}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text variant="h5">{t("balance.title")}</Text>
        <XStack width={58} />
      </XStack>
      <KeyboardAwareScreen
      ...
      >
        <YStack borderRadius={24} overflow="hidden" padding={22} gap={14}>
          ...
          >
            ...
            <WalletCards size={23} color="#FFFFFF" />
          </XStack>
          <Text
            position="relative"
            zIndex={1}
